...
- ✅ **Projet Hearst Qatar Project** - 58 containers, 17,864 mineurs, 8.45 EH/s
...
CREATE TABLE projects (
  ...
  name VARCHAR(100),                    -- 'Hearst Qatar Project Mining'
  type VARCHAR(50),                     -- 'mining', 'hosting'
  status VARCHAR(20),                   -- 'active', 'planned', 'maintenance'
  location VARCHAR(100),                -- 'Qatar Project', 'USA', etc.
...
- **Projet** : Métriques du projet Qatar Project uniquement
...
│                                                    │
│  🚨 ACTIVE ALERTS (3)                             │
│  ⚠️  Qatar Project-C12: High temperature (78°C)           │
│  ℹ️  Qatar Project-C45-M203: Maintenance due              │
...
```
┌────────────────────────────────────────────────────┐
│ 🏢 HEARST CONTROL > Qatar Project (QATAR-001)            │
├────────────────────────────────────────────────────┤
│                                                    │
│  📊 PROJECT METRICS                                │
│  ┌─────────────┬─────────────┬─────────────┐      │
...
### De l'ancienne structure (Qatar Project seul) vers multi-projets :
...
VALUES ('QATAR-001', 'Hearst Qatar Project Mining', ...);
