...
**Projet** : Qatar Project Mining Dashboard  
...
Qatar Project Mining Dashboard (qatar-dashboard)
  Isolé: ✅
  Indépendant: ✅
  Root: /Users/adrienbeyondcrypto/Desktop/Hearst Control /Qatar Project-Dashboard
```

**Projets configurés** : 1 projet actif
- **ID** : `qatar-dashboard`
- **Nom** : Qatar Project Mining Dashboard
- **Isolation** : ✅ Activée
...
**Pour Hearst Mining — Qatar Project Mining Dashboard**  
